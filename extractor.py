...
class Extractor:
    def __init__(self):
        ...
        self.df = pd.read_excel("/home/entrapolarity/project/linguistic_data_extraction/data/grammars.xlsx")
        self.lang_list = ["ca", "zh", "en", "fr", "de", "it", "pt", "ru", "es"]
        self.models = dict()
        self.stopwords = dict()
        self.embedder = SentenceTransformer('bert-base-multilingual-cased')

        modelPath = "/home/entrapolarity/project/linguistic_data_extraction/data/multilingual_cased"

        self.embedder.save(modelPath)
        self.embedder = SentenceTransformer(modelPath)

        with open("/home/entrapolarity/project/linguistic_data_extraction/data/language_files.json", 'r') as file:
    ...
    def extract_image(self, pdf_file, i, nums):
        ...
        image_names = []
        output_fname = "/home/entrapolarity/project/linguistic_data_extraction/static/output.pdf"
        ...
        for image in images:
            ...
            image.save("/home/entrapolarity/project/linguistic_data_extraction/static/" + image_name, 'JPEG')
            i += 1
    ...
    def extract(self, lang_about, query, method, description=True):
        ...
        for item in filenames:
            ...
            lang = item[1]
            absolute_path = "/home/entrapolarity/project/linguistic_data_extraction/data/"
            ...
            pdf_file = PyPDF2.PdfFileReader(fname)
            print(str(pdf_file.getDocumentInfo()))
            ...
            if not os.path.exists(fname_par):
                ...
                #command = "rclone copy \"gdrive:" + fname + "\" /home/entrapolarity/project/linguistic_data_extraction/data/Grammars_Updated --no-traverse --drive-chunk-size 32M -P"
                #os.system(command)
            ...
            if description:
                ...
                fname_desc = "/home/entrapolarity/project/linguistic_data_extraction/data/Grammars_Descriptions/" + term + ".json"
                fname_desc_lem = "/home/entrapolarity/project/linguistic_data_extraction/data/Grammars_Descriptions/" + term + "_lemmatized.json"
        ...
        for fname in fnames:
            ...
            fname_indices.append([1, 2, 3, 4, 5]) 
        indices = list(range(len(ans)))

        return ans, indices, image_files, fnames, fname_indices