...
def answer_reranker():
    ...
    res, indices, image_files = ext.extract(language, feature, method="Reranker")
    return render_template('extracted.html', res=res, indices=indices, image_files=image_files)
...
def answer_bm25():
    ...
    feature = request.form["feature"]
    language = request.form["language"]
    res, indices, image_files = ext.extract(language, feature, method="BM25")
    return render_template('extracted.html', res=res, indices=indices, image_files=image_files)
